        ...
        <div class="row">
          <div class="col-md-6">
            <div class="video-wrapper video-wrapper-main">
              <iframe src="https://youtube.com/embed/?autoplay=1&amp;mute=1&amp;modestbranding=1" allowfullscreen="allowfullscreen"></iframe>
            </div>
          </div>
          <div class="col-md-6">
            <h1 class="main-title">Благодарим Вас за регистрацию на наш мастер-класс<br/>У нас к Вам просьба, прямо сейчас <span>подпишитесь на наш телеграм</span>, там мы отправим Вам видео-урок "Название"<br/>Более того Вы сможете задать любой интересующий вас вопрос специалисту компании</h1>
            <h2 class="main-subtitle">Нажимайте на кнопку ниже</h2><a class="button button-promo" href="https://shop.mastervision.su/index.php?r=form/telegram&amp;id_bot=8">Подписаться <img src="../img/icons/tg.png" alt="Telegram"/></a>
          </div>
        </div>
        <p class="main-text">Обратите внимание, если вы не увидели во входящих сообщениях письмо благодарность, то обязательно проверьте вкладку <span>спам</span>, либо <span>промоакции</span></p><img class="main-img mian-img" src="../img/images/main.png" alt="Картинка блока"/>
      </div>
    </section>
    <footer>
      <div class="container">
        <h5>Хотите узнать больше? Вступайте в наши группы!</h5>
        <div class="soc-buttons"><a class="soc-button-fb" href="https://www.facebook.com/Mastervision1C/" target="_blank"></a><a class="soc-button-vk" href="https://vk.com/mv_akademia" target="_blank"></a><a class="soc-button-tw" href="https://twitter.com/MastervisionEzo" target="_blank"></a><a class="soc-button-insta" href="https://www.instagram.com/mastervision1/" target="_blank"></a><a class="soc-button-yt" href="https://www.youtube.com/channel/UCiJTdt19jRMRmYyCZac2Lvg/" target="_blank"></a><a class="soc-button-tg" href="https://t.me/Master_Vision_Academy" target="_blank"></a>
          <div class="clfix"></div>
        </div>
        <p>ИП Кудряшов Александр Анатольевич, Тюмень, проезд Летний, 9а, ИНН 720410077658, ОГРН 315723200065100</p>
      </div>
    </footer><!-- AutoWebOffice: UTM or OpenStat Counter -->
